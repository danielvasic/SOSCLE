...
<div class="container-fluid">
	<ul class="nav nav-tabs">
    	...
    	<li class="active"><a href="<?php echo site_url('upravljanjeGrupama/dodaj') ?>"><i class="icon icon-plus-sign"></i>&nbsp;Nova grupa</a></li>
    </ul>
    <div class="tab-content" id="sadrzaj">
    	<div class="well">
        	<h3>Forma za dodavanje grupa</h3>
        </div>
        <?php if (isset($greska)) { ?>
        ...
        <?php if (isset($success)) { ?>
             <div class="alert alert-success">
                <button type="button" class="close" data-dismiss="alert">×</button>
               <b>Bravo</b> uspješno ste dodali grupu u bazu podataka uskoro ćete biti preusmjereni.
            </div>
        <?php } ?>
        <form class="form-horizontal" action="<?php echo site_url('upravljanjeGrupama/dodaj') ?>" method="post">
        	<fieldset>
            	<div class="control-group">
                	<label class="control-label">Ime grupe <span class="red">*</span></label>
                    <div class="controls offset2">
                    	<input type="text" name="imeGrupe" class="input-xxlarge" value="<?php echo set_value('imeGrupe') ?>" placeholder="Unesite ime grupe" />
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls offset2">
                   	  <textarea name="opisGrupe" class="input-xxlarge" rows="3" placeholder="Unesite opis grupe"><?php echo set_value('opisGrupe') ?></textarea>
                    </div>
                </div>
