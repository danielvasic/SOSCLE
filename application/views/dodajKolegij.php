<?php 
$podaci = array ('naslov' => "Dodaj kolegij", 'logiraniKorisnik' => $logiraniKorisnik, 'aktivan' => 'kolegiji');
...
<div class="container-fluid">
	<ul class="nav nav-tabs">
    	...
    	<li class="active"><a href="<?php echo site_url ('upravljanjeKolegijima/dodaj') ?>"><i class="icon icon-plus-sign"></i>&nbsp;Dodaj kolegij</a></li>
    </ul>
    <div class="tab-content" id="sadrzaj">
        ...
        <form class="form-horizontal" action="<?php echo site_url ('upravljanjeKolegijima/dodaj') ?>" method="post">
        <fieldset>
            <div class="control-group">
                <label  class="control-label">Ime <span class="red">*</span></label>
                <div class="control offset2">
                    <input type="text" class="input-xlarge" name="ime" value="<?php echo set_value ('ime'); ?>" placeholder="Unesite ime kolegija ovdje" />
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div  class="control offset2">
                  <textarea name="opis" class="input-xlarge" rows="3" placeholder="Unesite opis kolegija ovdje"><?php echo set_value ('opis'); ?></textarea>
